...
public class BlueTele extends OpMode {
    ...
    public void init() {
        ...
        localizer.setPose(new Pose2D(DistanceUnit.INCH, 0, 0, AngleUnit.DEGREES, 180));
    ...
    public void loop() {
        ...
        if (shootingMode) {
            ...
            if (locked) {
                ...
                telemetry.addData("target rpm", getRPMForShot(meters) + c);
